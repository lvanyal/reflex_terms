...
By downloading, installing, or using Chess Reflex: ELO AI Puzzles ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the App.

These Terms apply to all visitors, users, and others who access or use the App.

## 2. Description of Service

Chess Reflex: ELO AI Puzzles is a mobile application that provides:
...
- The App offers premium subscriptions with additional features
- Subscription terms and prices are displayed in the App
...
### 4.3 Free Trials
- Free trial periods, if offered, are specified in the App
...
- Refund requests should be directed to the App Store per their policies
...
- The chess puzzles, UI design, and educational content are proprietary
...
- This license does not include rights to copy, modify, or distribute the App's content
...
- Adapty for subscription management and paywall optimization
...
The App is for entertainment and educational purposes only. Chess skill improvements are not guaranteed.
...
- Any bugs, viruses, or similar harmful code transmitted through the App
- Any errors or omissions in content

IN NO EVENT SHALL OUR AGGREGATE LIABILITY EXCEED THE AMOUNT YOU PAID TO US IN THE PAST TWELVE MONTHS OR $100, WHICHEVER IS LESS.

## 11. Indemnification

You agree to indemnify, defend, and hold harmless the App, its developers, and affiliates from any claims, damages, losses, liabilities, costs, and expenses arising from your use of the App or violation of these Terms.
...
- Conduct that we believe harms the App or other users
- Extended periods of inactivity
- Request by law enforcement or government agencies

### 12.3 Effect of Termination
Upon termination, your license to use the App will immediately cease. Provisions that by their nature should survive termination shall survive.
...
Any disputes arising from these Terms or the App shall be resolved in the courts of Delaware, and you consent to personal jurisdiction in these courts.

## 14. Changes to Terms

We reserve the right to modify these Terms at any time. Changes will be effective when posted in the App. Your continued use of the App after changes constitutes acceptance of the modified Terms.

We will notify users of material changes through the App or via email when possible.
...
*By using Chess Reflex: ELO AI Puzzles, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.*